...
3. **Notification CNIL** : Confusion sur délai (certains pensaient 7 jours au lieu de 72h)
4. **Communication patients** : Décision non préparée (qui décide, quel message)
5. **Restauration** : Procédure non documentée (étapes, contacts)
...
- **Délai CNIL** : Clarifier 72h (article 33 RGPD) - Critique
- **Kit de crise** : Créer (contacts urgents, modèles communication) - Critique
- **Communication patients** : Définir procédure (qui décide, quel message, quand) - Critique
- **Procédure restauration** : Documenter (étapes, contacts prestataire) - Important
